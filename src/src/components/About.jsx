...
<div className="bg-[#faf7f7] py-8 px-6 lg:px-16">
  <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-5 mt-8">
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 mt-2 text-sm">
              Book nearby ambulances within seconds anytime, anywhere.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 mt-2 text-sm">
              Advanced life support and emergency medical facilities available.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 mt-2 text-sm">
              Track ambulance location and estimated arrival time live.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 mt-2 text-sm">
              Verified ambulance partners with trained medical staff.
            </p>
          </div>
    ...
    {/* Bottom CTA */}
    <div className="mt-15 bg-white rounded-xl p-10 flex flex-col lg:flex-row items-center justify-between gap-6 shadow-md">
      ...
      <button className=" bg-red-500 font-semibold px-8 py-4 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg">
        Book Ambulance Now
      </button>
