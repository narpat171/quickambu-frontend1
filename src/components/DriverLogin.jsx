  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-linear-to-r from-red-50 to-white flex items-center justify-center px-4 py-10 relative overflow-hidden">
        ...
        {/* 👇 यहाँ relative और overflow-hidden ज़रूरी है ताकि लोडर कार्ड के अंदर ही रहे */}
        <div className="w-full max-w-md bg-white shadow-lg rounded-xl border p-8 relative overflow-hidden" data-aos="fade-up">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex justify-end mt-2">
              {/* 👇 5. Link हटाकर button लगाया और onClick इफ़ेक्ट जोड़ दिया (Tailwind style के साथ) */}
              <button 
                type="button" 
                onClick={() => handleNavigate('/driver-forgot-password')} 
                className="text-sm text-blue-600 hover:text-blue-500 font-bold transition-colors cursor-pointer bg-transparent border-none p-0 outline-none"
              >
                Forgot Password?
              </button>
            </div>
            ...
            <div className="text-center pt-2">
              ...
              <button 
                type="button" 
                onClick={() => handleNavigate('/AmbuRegister')} 
