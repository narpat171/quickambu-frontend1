...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    // 🧹 BUG FIX: ब्राउज़र की मेमोरी से पुरानी फंसी हुई लिस्ट हमेशा के लिए डिलीट
          ...
          <div className="space-y-4 transition-all duration-300 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 items-start">
              {displayedAmbulances.map((amb) => {
                ...
                // अगर इस एम्बुलेंस की कोई राइड चल रही है और वो "Completed" नहीं हुई है, तो मतलब वो "Dispatched" है।
                    ...
                    <div className="p-4 md:p-5 flex-1 flex flex-col justify-between space-y-4">
                      <div>
                        <div className="flex justify-between items-start gap-2">
                          ...
                          {/* ➔ सिर्फ 2 स्टेटस: Dispatched या Available */}
